    ...
    targetList.addAll([
      TargetFocus(keyTarget: whatsapppBoxKey,contents:[
        TargetContent(
          ...
          children: [
            Text("Direct chat with admin",style: TextStyle(color: Colors.white,fontSize: 14,fontWeight: FontWeight.w500),)
          ],
        ) )
      ] ),
      TargetFocus(keyTarget: contactBoxKey,contents:[
        TargetContent(
            ...
            align: ContentAlign.bottom,child: Column(
          children: [
            Text("Contact with admin",style: TextStyle(color: Colors.white,fontSize: 14,fontWeight: FontWeight.w500),)
          ],
        ) )
      ] ),
      TargetFocus(keyTarget:cateBoxKey,contents:[
        TargetContent(
            ...
            align: ContentAlign.bottom ,child: Column(
          children: [
            Text("All categories",style: TextStyle(color: Colors.white,fontSize: 14,fontWeight: FontWeight.w600),)
          ],
        ) )
      ] ),
    ]);
