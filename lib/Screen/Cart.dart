  ...
  addDeliveryCharge(String addId)async{
    ...
    if (response.statusCode == 200) {
      ...
      setState(() {
        ...
        finalValues =  double.parse(finalAmount.toString()) + double.parse(dCharge.toString());
 ...
 /// String? unittext;
  ...
  doPayment() {
    ...
    if (payMethod == getTranslated(context, 'PAYPAL_LBL')) {
      ...
      UpiPayment upiPayment = new UpiPayment(totalamount!, context, (value) {
                ...
                children: [
                  Row(
                    children: [
                      Expanded(
                          child:
                         radioData == null ? Text("s") : Text("${radioData!.name}, ${radioData!.addItem!.address}, ${radioData!.addItem!.cityId}, ${radioData!.addItem!.state}, ${radioData!.addItem!.country}")),
                      InkWell(
                        child: Padding(
                          padding:
                          const EdgeInsets.symmetric(horizontal: 8.0),
